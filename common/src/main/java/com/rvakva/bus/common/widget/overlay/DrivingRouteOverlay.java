package com.rvakva.bus.common.widget.overlay;
...
//        mPolylineOptions.color(getDriveColor()).width(getRouteWidth());
        mPolylineOptions.setCustomTexture(BitmapDescriptorFactory.fromResource(R.drawable.custtexture_green_row)).width(getRouteWidth());
    }
